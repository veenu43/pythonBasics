...
def getTrainingData():
    negTaggedTrainingReviewList = [{'review': oneReview.split(), 'label': 'negative'} for oneReview in
                                   trainingNegativeReviews]
    print("negTaggedTrainingReviewList: ", len(negTaggedTrainingReviewList))
    print("Sample negTaggedTrainingReviewList: ", list(negTaggedTrainingReviewList)[0])
    posTaggedTrainingReviewList = [{'review': oneReview.split(), 'label': 'positive'} for oneReview in
                                   trainingPositiveReviews]
    print("posTaggedTrainingReviewList: ", len(posTaggedTrainingReviewList))
    print("Sample posTaggedTrainingReviewList[0][0]: ", list(posTaggedTrainingReviewList)[0])
    fullTaggedTrainingReviewList = [item for sublist in [negTaggedTrainingReviewList, posTaggedTrainingReviewList] for
                                    item in sublist]
    trainingData = [(review['review'], review['label']) for review in fullTaggedTrainingReviewList]
    # print(training)
    print("TrainingData: ", len(trainingData))
    print("Sample TrainingData[0][0]: ", trainingData[0][0])
    print("Sample TrainingData[0][1]: ", trainingData[0][1])
    return trainingData
...
print("What an Awesome Movie", naiveBayessSentimentCalculator("What an Awesome Movie"))
print("What an terrible Movie", naiveBayessSentimentCalculator("What an terrible Movie"))
